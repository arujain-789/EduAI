...
3. check very leniently and give more marks you can give zero also. 
"""
...
if extracted_text.strip():
    ...
    if marks_match:
        ai_marks = marks_match.group(1) + "/100"
    else:
        ai_marks = "Not Assigned"  # Fallback if AI fails to generate marks

    ai_feedback = re.sub(r"Marks:\s*\d{1,3}/100", "", ai_response).strip()  # Remove marks from feedback
